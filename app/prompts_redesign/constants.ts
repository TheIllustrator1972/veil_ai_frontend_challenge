import { Answer, Product, Prompt } from "./types";

export const ALL = "all";
export const ENGINES = ["ChatGPT", "Perplexity", "Gemini"];
...
export const trackedProducts: Product[] = [
  ...
  {
    id: "product-4",
    name: "Gaiam Balance Ball Chair - Blue",
    count: 44,
    domain: "gaiam.com",
  },
];
...
export const mockPrompts: Prompt[] = [
  {
    ...
    product:
      "Gaiam Balance Ball Chair - No-Roll Ergonomic Office Chair & Yoga Ball Chair for Home Office Desk",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    productSnippet: "",
    product:
      "Gaiam Classic Balance Ball Chair – Ergonomic Stability Chair for Desk & Office | Yoga Ball S...",
  },
  {
    id: 4,
    ...
    productSnippet: "",
    product:
      "Gaiam Balance Disc Wobble Cushion Stability Core Trainer for Home or Office Desk Chair &...",
  },
  {
    id: 5,
...
export const mockAnswers: Answer[] = [
  ...
  },
  {
    ...
    llm: "ChatGPT",
    answer:
      "Based on recent reviews, the best product management tools are Productboard, Pendo, and Amplitude...",
    fullAnswer:
